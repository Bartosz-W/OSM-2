...
extern "C"
    ...
    void DWHCITransferStageData(TDWHCITransferStageData *pThis,
	    unsigned nChannel, TUSBRequest *pURB, boolean bIn,
	    boolean bStatusStage);
    void _DWHCITransferStageData(TDWHCITransferStageData *pThis);

// change status
    void DWHCITransferStageDataTransactionComplete(
	    TDWHCITransferStageData *pThis, u32 nStatus, u32 nPacketsLeft,
	    u32 nBytesLeft);
    ...
    boolean DWHCITransferStageDataBeginSplitCycle(
	    TDWHCITransferStageData *pThis);

// get transaction parameters
    unsigned DWHCITransferStageDataGetChannelNumber(
	    TDWHCITransferStageData *pThis);
    ...
    u32 DWHCITransferStageDataGetBytesToTransfer(
	    TDWHCITransferStageData *pThis);
    u32 DWHCITransferStageDataGetPacketsToTransfer(
	    TDWHCITransferStageData *pThis);

    boolean DWHCITransferStageDataIsSplit(TDWHCITransferStageData *pThis);
    boolean DWHCITransferStageDataIsSplitComplete(
	    TDWHCITransferStageData *pThis);
...
// check status after transaction
    u32 DWHCITransferStageDataGetTransactionStatus(
	    TDWHCITransferStageData *pThis);
    boolean DWHCITransferStageDataIsStageComplete(
	    TDWHCITransferStageData *pThis);
    ...
    TDWHCIFrameScheduler *DWHCITransferStageDataGetFrameScheduler(
	    TDWHCITransferStageData *pThis);
