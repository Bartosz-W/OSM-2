...
#define UMSD_MAX_OFFSET		0x1FFFFFFFFFFULL		// 2TB
    ...
    unsigned long long USBBulkOnlyMassStorageDeviceSeek(
	    TUSBBulkOnlyMassStorageDevice *pThis, unsigned long long ullOffset);

    unsigned USBBulkOnlyMassStorageDeviceGetCapacity(
